...
internal readonly ref partial struct Span2D<T>
{
...
#if NET8_0_OR_GREATER
        reference = ref array.DangerousGetReferenceAt(offset);
        this.height = height;
#elif NETSTANDARD2_1_OR_GREATER
...
#if NET8_0_OR_GREATER
        reference = ref array.DangerousGetReference();
...
#if NET8_0_OR_GREATER
        reference = ref array.DangerousGetReferenceAt(row, column);
        this.height = height;
#elif NETSTANDARD2_1_OR_GREATER
...
#if NET8_0_OR_GREATER
        reference = ref array.DangerousGetReferenceAt(depth, 0, 0);
...
#if NET8_0_OR_GREATER
        reference = ref array.DangerousGetReferenceAt(depth, row, column);
        this.height = height;
#elif NETSTANDARD2_1_OR_GREATER
...
#if NET8_0_OR_GREATER
        reference = ref span.DangerousGetReferenceAt(offset);
        this.height = height;
#else
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => (nint)(uint)Height * (nint)(uint)width;
    }
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => ref this[row.GetOffset(Height), column.GetOffset(width)];
    }
...
#endif
        nint index = ((nint)(uint)i * (nint)(uint)Stride) + (nint)(uint)j;
    ...
    public unsafe Span2D<T> Slice(int row, int column, int height, int width)
    {
        ...
        nint shift = ((nint)(uint)Stride * (nint)(uint)row) + (nint)(uint)column;
        int pitch = Stride - width;

#if NET8_0_OR_GREATER
        ref T r0 = ref Unsafe.Add(ref reference, shift);
    ...
    public Span<T> GetRowSpan(int row)
    {
        ...
        return MemoryMarshal.CreateSpan(ref r0, width);
    }
#endif
    ...
    public bool TryGetSpan(out Span<T> span)
    {
        ...
        {
#if NET8_0_OR_GREATER
            span = MemoryMarshal.CreateSpan(ref reference, (int)Length);
