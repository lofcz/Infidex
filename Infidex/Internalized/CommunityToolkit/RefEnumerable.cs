...
public readonly ref struct RefEnumerable<T>
{
    ...
    {
#if NET8_0_OR_GREATER
        return new Enumerator(ref Reference, length, Step);
#elif NETSTANDARD2_1_OR_GREATER
    ...
    public void Clear()
    {
        ...
        if (Step == 1)
        {
            MemoryMarshal.CreateSpan(ref Reference, this.length).Clear();
    ...
    public void CopyTo(RefEnumerable<T> destination)
    {
        ...
        if (Step == 1)
        {
            destination.CopyFrom(MemoryMarshal.CreateReadOnlySpan(ref Reference, length));
    ...
    public void CopyTo(Span<T> destination)
    {
        ...
        if (Step == 1)
        {
            MemoryMarshal.CreateReadOnlySpan(ref Reference, this.length).CopyTo(destination);
    ...
    internal void CopyFrom(ReadOnlySpan<T> source)
    {
        ...
        if (Step == 1)
        {
            source.CopyTo(MemoryMarshal.CreateSpan(ref Reference, length));

            return;
        }

        ref T destinationRef = ref Reference;
    ...
    public void Fill(T value)
    {
        ...
        if (Step == 1)
        {
            MemoryMarshal.CreateSpan(ref Reference, this.length).Fill(value);
    ...
    public ref struct Enumerator
    {
        ...
        public readonly ref T Current
        {
            ...
            get
            {
                ...
                nint offset = (nint)(uint)position * (nint)(uint)step;
                ref T ri = ref Unsafe.Add(ref r0, offset);
